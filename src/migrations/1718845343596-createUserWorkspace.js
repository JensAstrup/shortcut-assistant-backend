...
module.exports = class AddGoogleId1718845343596 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "auth_users" ADD CONSTRAINT "FK_644a803e68bebd3eedff879ac96" FOREIGN KEY ("workspaceId") REFERENCES "workspace"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE "auth_users" DROP CONSTRAINT "FK_644a803e68bebd3eedff879ac96"`);
